...
//            if (mConnection == null) return null; mConnection.setConnectTimeout(5000);
//            mConnection.setUseCaches(false); mConnection.setDoOutput(true);
...
//        if (index == -1) {
//        mVer = null; } else { mVer = mData.substring(index + startToken.length(), index + startToken.length() + 100); mVer = mVer.substring(0, mVer.indexOf(endToken)).trim(); } return mVer; } }
