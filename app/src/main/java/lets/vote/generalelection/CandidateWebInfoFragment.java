...
public class CandidateWebInfoFragment extends Fragment {
    static CandidateWebInfoFragment instance;
    private WebView infoWebView; // 웹뷰 선언
    private WebSettings mWebSettings; //웹뷰세팅


    public CandidateWebInfoFragment() {
        // Required empty public constructor
    }

    public static CandidateWebInfoFragment getInstance() {
        if (instance == null) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String candidateId = getArguments().getString("candidateId");
